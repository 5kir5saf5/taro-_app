...
async def buy_menu(callback: CallbackQuery):
    await callback.message.edit_text(
        ...
        "✨ **8 вопросов** — 100 ₽\n"
        "🌟 **15 вопросов** — 350 ₽\n\n"
        "💳 **Реквизиты карты Тинькофф:** `2200 7019 2912 3708`\n"
        "📌 В комментарии желательно укажи свой Telegram ID\n\n"
        "📸 После оплаты отправь скрин чека сюда\n"
        "Администратор начислит вопросы вручную\n\n"
        "⏳ Обычно это занимает от нескольки минут, до часа.",
...
async def payment_screenshot(message: types.Message):
    ...
    await message.answer(
        ...
        "Обычно это занимает от пары минут, до часу.\n\n"
